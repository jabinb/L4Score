...
OBJECTS = sdk/smsdk_ext.cpp extension.cpp util.cpp asm/asm.c detours/gamerules_networkchanged.cpp detours/detour.cpp detours/recompute_team_scores.cpp detours/recalculate_versus_score.cpp codepatch/patchmanager.cpp natives.cpp vglobals.cpp
...
ifeq "$(USEMETA)" "true"
	...
	INCLUDE += -I$(HL2PUB) -I$(HL2PUB)/engine -I$(HL2PUB)/tier0 -I$(HL2PUB)/tier1 -I$(METAMOD) \
		-I$(METAMOD)/sourcehook -I$(SMSDK)/public/extensions -I$(SMSDK)/public/sourcepawn
